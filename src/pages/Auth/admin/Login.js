...
export class AdminLoginClass extends Component {
  state = {
    formFields: {
      email: '',
      password: '',
      ...
      <>
        <div className="auth-container-login w-100 py-5 py-lg-4">
          <div className="text-center text-white">
            ...
            <h3 className="m-0 fw-600">Admin Login</h3>
          </div>
          <div className="inner-container py-4">
            <form className="col-5 aligncenter">
              ...
              <div className="form-group mb-0 d-flex flex-wrap justify-content-center pt-4">
                ...
                />
                <Link className="w-100" to="/admin/verifyOTP">
                  <NormalButton
...
export const AdminLogin = connect(null, mapDispatchToProps)(AdminLoginClass);
